...
-- Date        : Tue Mar 28 11:29:40 2023
-- Host        : Xilinx-Omniverse running 64-bit Ubuntu 22.04.2 LTS
-- Command     : write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ kria_eth_top_clk_wiz_0_0_sim_netlist.vhdl
-- Design      : kria_eth_top_clk_wiz_0_0
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_kria_eth_top_clk_wiz_0_0_clk_wiz is
  port (
    clk_333 : out STD_LOGIC;
    resetn : in STD_LOGIC;
    clk_in1 : in STD_LOGIC
  );
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_kria_eth_top_clk_wiz_0_0_clk_wiz;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_kria_eth_top_clk_wiz_0_0_clk_wiz is
  signal clk_333_kria_eth_top_clk_wiz_0_0 : STD_LOGIC;
  signal clk_in1_kria_eth_top_clk_wiz_0_0 : STD_LOGIC;
...
clkin1_ibuf: unisim.vcomponents.IBUF
    generic map(
      ...
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => clk_in1,
      O => clk_in1_kria_eth_top_clk_wiz_0_0
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_333_kria_eth_top_clk_wiz_0_0,
      O => clk_333
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      BANDWIDTH => "OPTIMIZED",
      CLKFBOUT_MULT_F => 84.500000,
      ...
      CLKIN1 => clk_in1_kria_eth_top_clk_wiz_0_0,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_333_kria_eth_top_clk_wiz_0_0,
...
begin
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_kria_eth_top_clk_wiz_0_0_clk_wiz
     port map (
      clk_333 => clk_333,
      clk_in1 => clk_in1,
      resetn => resetn
