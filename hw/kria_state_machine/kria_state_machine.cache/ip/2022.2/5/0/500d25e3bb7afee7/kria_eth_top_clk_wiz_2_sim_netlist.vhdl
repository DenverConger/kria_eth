...
-- Date        : Tue Mar 28 11:58:58 2023
-- Host        : Xilinx-Omniverse running 64-bit Ubuntu 22.04.2 LTS
-- Command     : write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ kria_eth_top_clk_wiz_2_sim_netlist.vhdl
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_kria_eth_top_clk_wiz_2_clk_wiz is
  port (
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_kria_eth_top_clk_wiz_2_clk_wiz;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_kria_eth_top_clk_wiz_2_clk_wiz is
  signal clk_125_kria_eth_top_clk_wiz_2 : STD_LOGIC;
  signal clk_in1_kria_eth_top_clk_wiz_2 : STD_LOGIC;
  signal clk_out2_kria_eth_top_clk_wiz_2 : STD_LOGIC;
...
clkout2_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out2_kria_eth_top_clk_wiz_2,
      O => clk_out2
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKOUT0 => clk_125_kria_eth_top_clk_wiz_2,
      CLKOUT0B => NLW_mmcme4_adv_inst_CLKOUT0B_UNCONNECTED,
      CLKOUT1 => clk_out2_kria_eth_top_clk_wiz_2,
...
begin
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_kria_eth_top_clk_wiz_2_clk_wiz
     port map (
      clk_125 => clk_125,
      clk_in1 => clk_in1,
      clk_out2 => clk_out2,
