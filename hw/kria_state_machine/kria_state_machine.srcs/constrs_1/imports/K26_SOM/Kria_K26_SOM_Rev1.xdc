...
set_property -dict {LOC L3 IOSTANDARD LVDS} [get_ports clk_200mhz_p];
set_property -dict {LOC K3 IOSTANDARD LVDS} [get_ports clk_200mhz_n];
create_clock -period 5.000 -name clk_200mhz [get_ports clk_200mhz_p];

#set_property PACKAGE_PIN J1 [get_ports rgmii_tx_clk] #  
#set_property PACKAGE_PIN U9 [get_ports rgmii_txd[0]] #  
#set_property PACKAGE_PIN V9 [get_ports rgmii_txd[1]] #    
#set_property PACKAGE_PIN U8 [get_ports rgmii_txd[2]] # 
#set_property PACKAGE_PIN V8 [get_ports rgmii_txd[3]] #  
#set_property PACKAGE_PIN Y8 [get_ports rgmii_tx_ctl] #   

#set_property PACKAGE_PIN K4 [get_ports rgmii_rx_clk] #   
#set_property PACKAGE_PIN H1 [get_ports rgmii_rxd[0]] #    
#set_property PACKAGE_PIN K2 [get_ports rgmii_rxd[1]] #     
#set_property PACKAGE_PIN J2 [get_ports rgmii_rxd[2]] #    
#set_property PACKAGE_PIN H4 [get_ports rgmii_rxd[3]] #    
#set_property PACKAGE_PIN H3 [get_ports rgmii_rx_ctl] # 
  
#set_property PACKAGE_PIN R8 [get_ports gem3_mdc] #    
#set_property PACKAGE_PIN T8 [get_ports gem_3_mdio_out] #  

set_property -dict { PACKAGE_PIN J1 IOSTANDARD LVCMOS18 } [get_ports { phy_tx_clk }];
set_property -dict { PACKAGE_PIN U9 IOSTANDARD LVCMOS18 } [get_ports { phy_txd[0] }];  
set_property -dict { PACKAGE_PIN V9 IOSTANDARD LVCMOS18 } [get_ports { phy_txd[1] }];  
set_property -dict { PACKAGE_PIN U8 IOSTANDARD LVCMOS18 } [get_ports { phy_txd[2] }];
set_property -dict { PACKAGE_PIN V8 IOSTANDARD LVCMOS18 } [get_ports { phy_txd[3] }];  
set_property -dict { PACKAGE_PIN Y8 IOSTANDARD LVCMOS18 } [get_ports { phy_tx_ctl }];
 
set_property PACKAGE_PIN K4 [get_ports phy_rx_clk]  
set_property IOSTANDARD LVCMOS18 [get_ports phy_rx_clk]  
set_property PACKAGE_PIN H1 [get_ports phy_rxd[0]] 
set_property IOSTANDARD LVCMOS18 [get_ports phy_rxd[0]]
set_property PACKAGE_PIN K2 [get_ports phy_rxd[1]]
set_property IOSTANDARD LVCMOS18 [get_ports phy_rxd[1]]
set_property PACKAGE_PIN J2 [get_ports phy_rxd[2]]    
set_property IOSTANDARD LVCMOS18 [get_ports phy_rxd[2]]
set_property PACKAGE_PIN H4 [get_ports phy_rxd[3]]    
set_property IOSTANDARD LVCMOS18 [get_ports phy_rxd[3]]
set_property PACKAGE_PIN H3 [get_ports phy_rx_ctl] 
set_property IOSTANDARD LVCMOS18 [get_ports phy_rx_ctl]
  

set_property PACKAGE_PIN K1 [get_ports phy_reset_n]
set_property IOSTANDARD LVCMOS18 [get_ports phy_reset_n]

set_property PACKAGE_PIN R8 [get_ports gem3_mdc]
set_property IOSTANDARD LVCMOS18 [get_ports gem3_mdc]
set_property PACKAGE_PIN T8 [get_ports gem_3_mdio_out] 
set_property IOSTANDARD LVCMOS18 [get_ports gem_3_mdio_out]
#set_property PACKAGE_PIN R7 [get_ports led[0]] #  
#set_property PACKAGE_PIN T7 [get_ports led[1]] #  
#set_property PACKAGE_PIN L1 [get_ports led[2]] #  

# pmod1_gpio 
set_property PACKAGE_PIN H12 [get_ports btnu]
set_property IOSTANDARD LVCMOS33 [get_ports btnu]
set_property PACKAGE_PIN E10 [get_ports btnl]
set_property IOSTANDARD LVCMOS33 [get_ports btnl]
set_property PACKAGE_PIN D10 [get_ports btnd]
set_property IOSTANDARD LVCMOS33 [get_ports btnd]
set_property PACKAGE_PIN C11 [get_ports btnr]
set_property IOSTANDARD LVCMOS33 [get_ports btnr]
set_property PACKAGE_PIN B10 [get_ports btnc]
set_property IOSTANDARD LVCMOS33 [get_ports btnc]

#Other net   PACKAGE_PIN U12      - GND                       Bank   0 - DXN
#Other net   PACKAGE_PIN P12      - VCC_PLADC                 Bank   0 - VCCADC
#Other net   PACKAGE_PIN PU913      - PLADC_AGND                Bank   0 - GNDADC
