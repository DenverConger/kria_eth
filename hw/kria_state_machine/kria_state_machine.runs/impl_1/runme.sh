...
HD_PWD='/home/denmann99/Documents/kria_eth/hw/kria_state_machine/kria_state_machine.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log kria_eth_top_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source kria_eth_top_wrapper.tcl -notrace
