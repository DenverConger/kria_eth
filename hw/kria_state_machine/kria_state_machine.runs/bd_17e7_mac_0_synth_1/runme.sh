...
HD_PWD='/home/denmann99/Documents/kria_eth/hw/kria_state_machine/kria_state_machine.runs/bd_17e7_mac_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_17e7_mac_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_17e7_mac_0.tcl
